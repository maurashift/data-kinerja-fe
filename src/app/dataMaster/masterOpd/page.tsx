  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <h1 className="text-xl font-bold text-gray-800">DAFTAR OPD</h1>
        
        {/* Tombol Tambah yang mengarah ke halaman create */}
        {/* Kita asumsikan nanti Anda buat halaman tambahnya di /dataMaster/masterOpd/tambah */}
        <ButtonSky onClick={() => router.push('/dataMaster/masterOpd/tambah')}>
           + Tambah OPD
        </ButtonSky>
      </div>
